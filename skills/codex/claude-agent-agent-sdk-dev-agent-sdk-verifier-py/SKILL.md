---
name: claude-agent-agent-sdk-dev-agent-sdk-verifier-py
description: Converted from Claude plugin agent "agent-sdk-verifier-py" (agent-sdk-dev).
  Use when the user wants this agent behavior. Use this agent to verify that a Python
  ...
  after a Python Agent SDK app has been created or modified.
---

# Claude Agent (Imported): agent-sdk-verifier-py

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\agent-sdk-dev\2cd88e7947b7\agents\agent-sdk-verifier-py.md`
