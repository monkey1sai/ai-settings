---
name: claude-agent-agent-sdk-dev-agent-sdk-verifier-ts
description: Converted from Claude plugin agent "agent-sdk-verifier-ts" (agent-sdk-dev).
  Use when the user wants this agent behavior. Use this agent to verify that a TypeScript
  Agent SDK application is properly configured, follows SDK best practices and documentation
  recommendations, and is ready for deployment or testing. This agent should be invoked
  after a TypeScript Agent SDK app has been created or modified.
---

# Claude Agent (Imported): agent-sdk-verifier-ts

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\agent-sdk-dev\2cd88e7947b7\agents\agent-sdk-verifier-ts.md`
