---
name: claude-agent-coderabbit-code-reviewer
description: Converted from Claude plugin agent "code-reviewer" (coderabbit). Use
  when the user wants this agent behavior. Specialized CodeRabbit code review agent
  that performs thorough analysis of code changes
---
