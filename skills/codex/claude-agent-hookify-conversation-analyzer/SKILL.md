---
name: claude-agent-hookify-conversation-analyzer
description: Converted from Claude plugin agent "conversation-analyzer" (hookify).
  Use when the user wants this agent behavior. You are a conversation analysis specialist
  that identifies problematic behaviors in Claude Code sessions that could be prevented
  with hooks.
---

# Claude Agent (Imported): conversation-analyzer

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\hookify\2cd88e7947b7\agents\conversation-analyzer.md`
- Plugin: `hookify`
