---
name: claude-agent-posthog-error-analyzer
description: Converted from Claude plugin agent "error-analyzer" (posthog). Use when
  the user wants this agent behavior. Analyze multiple PostHog errors in parallel
  to identify patterns, root causes, and prioritize fixes based on user impact.
---

# Claude Agent (Imported): error-analyzer

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\posthog\1.0.0\agents\error-analyzer.md`
- Plugin: `posthog`
- Version: `1.0.0`
