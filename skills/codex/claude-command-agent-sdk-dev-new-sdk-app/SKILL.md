---
name: claude-command-agent-sdk-dev-new-sdk-app
description: Converted from Claude plugin command "new-sdk-app" (agent-sdk-dev). Use
  when the user wants to run this slash-command workflow. Create and setup a new Claude
  Agent SDK application
---

# Claude Command (Imported): new-sdk-app

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\agent-sdk-dev\2cd88e7947b7\commands\new-sdk-app.md`
