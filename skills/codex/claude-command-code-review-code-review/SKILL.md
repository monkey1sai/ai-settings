---
name: claude-command-code-review-code-review
description: Converted from Claude plugin command "code-review" (code-review). Use
  when the user wants to run this slash-command workflow. Code review a pull request
---

# Claude Command (Imported): code-review

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\code-review\2cd88e7947b7\commands\code-review.md`
- Plugin: `code-review`
