---
name: claude-command-firecrawl-agent
description: Converted from Claude plugin command "agent" (firecrawl). Use when the
  user wants to run this slash-command workflow. Use AI agent for autonomous web data
  gathering
---
