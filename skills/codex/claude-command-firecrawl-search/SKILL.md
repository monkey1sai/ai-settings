---
name: claude-command-firecrawl-search
description: Converted from Claude plugin command "search" (firecrawl). Use when the
  user wants to run this slash-command workflow. Search the web and get scraped results
---

# Claude Command (Imported): search

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\firecrawl\1.0.0\commands\search.md`
- Plugin: `firecrawl`
- Version: `1.0.0`
...
allowed-tools: firecrawl_search
```
