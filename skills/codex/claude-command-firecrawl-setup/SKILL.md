---
name: claude-command-firecrawl-setup
description: Converted from Claude plugin command "setup" (firecrawl). Use when the
  user wants to run this slash-command workflow. Set up Firecrawl API key and verify
  configuration
---

# Claude Command (Imported): setup

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\firecrawl\1.0.0\commands\setup.md`
- Plugin: `firecrawl`
- Version: `1.0.0`
