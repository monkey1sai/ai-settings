---
name: claude-command-hookify-configure
description: Converted from Claude plugin command "configure" (hookify). Use when
  the user wants to run this slash-command workflow. Enable or disable hookify rules
  interactively
---

# Claude Command (Imported): configure

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\hookify\2cd88e7947b7\commands\configure.md`
- Plugin: `hookify`
