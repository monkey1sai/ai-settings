---
name: claude-command-hookify-help
description: Converted from Claude plugin command "help" (hookify). Use when the user
  wants to run this slash-command workflow. Get help with the hookify plugin
---

# Claude Command (Imported): help

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\hookify\2cd88e7947b7\commands\help.md`
- Plugin: `hookify`
