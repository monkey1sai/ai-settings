---
name: claude-command-hookify-hookify
description: Converted from Claude plugin command "hookify" (hookify). Use when the
  user wants to run this slash-command workflow. Create hooks to prevent unwanted
  behaviors from conversation analysis or explicit instructions
---

# Claude Command (Imported): hookify

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\hookify\2cd88e7947b7\commands\hookify.md`
- Plugin: `hookify`
