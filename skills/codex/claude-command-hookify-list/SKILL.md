---
name: claude-command-hookify-list
description: Converted from Claude plugin command "list" (hookify). Use when the user
  wants to run this slash-command workflow. List all configured hookify rules
---

# Claude Command (Imported): list

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\hookify\2cd88e7947b7\commands\list.md`
- Plugin: `hookify`
