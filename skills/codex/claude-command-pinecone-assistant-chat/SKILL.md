---
name: claude-command-pinecone-assistant-chat
description: Converted from Claude plugin command "assistant-chat" (pinecone). Use
  when the user wants to run this slash-command workflow. Chat with a Pinecone Assistant
  and receive answers with source citations
---

# Claude Command (Imported): assistant-chat

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\assistant-chat.md`
- Plugin: `pinecone`
- Version: `1.1.2`
