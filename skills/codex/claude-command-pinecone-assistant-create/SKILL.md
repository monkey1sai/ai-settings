---
name: claude-command-pinecone-assistant-create
description: Converted from Claude plugin command "assistant-create" (pinecone). Use
  when the user wants to run this slash-command workflow. Create a new Pinecone Assistant
  for document Q&A with citations
---

# Claude Command (Imported): assistant-create

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\assistant-create.md`
- Plugin: `pinecone`
- Version: `1.1.2`
