---
name: claude-command-pinecone-assistant-list
description: Converted from Claude plugin command "assistant-list" (pinecone). Use
  when the user wants to run this slash-command workflow. Overview
---

# Claude Command (Imported): assistant-list

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\assistant-list.md`
- Plugin: `pinecone`
- Version: `1.1.2`
