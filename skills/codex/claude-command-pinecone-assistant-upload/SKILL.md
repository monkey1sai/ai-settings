---
name: claude-command-pinecone-assistant-upload
description: Converted from Claude plugin command "assistant-upload" (pinecone). Use
  when the user wants to run this slash-command workflow. Upload files or repository
  contents to a Pinecone Assistant's knowledge base
---

# Claude Command (Imported): assistant-upload

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\assistant-upload.md`
- Plugin: `pinecone`
- Version: `1.1.2`
