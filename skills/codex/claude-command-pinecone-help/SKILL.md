---
name: claude-command-pinecone-help
description: Converted from Claude plugin command "help" (pinecone). Use when the
  user wants to run this slash-command workflow. Explain how to use the Pinecone plugin
  with Claude Code. Helps users set API keys, learn existing functionality, or do
  a quickstart.
---

# Claude Command (Imported): help

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\help.md`
- Plugin: `pinecone`
- Version: `1.1.2`
