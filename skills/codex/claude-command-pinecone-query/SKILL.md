---
name: claude-command-pinecone-query
description: Converted from Claude plugin command "query" (pinecone). Use when the
  user wants to run this slash-command workflow. Query a user's index with Pinecone
  MCP. Accept an index name, input query, and optionally a top-k value
---

# Claude Command (Imported): query

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\query.md`
- Plugin: `pinecone`
- Version: `1.1.2`
