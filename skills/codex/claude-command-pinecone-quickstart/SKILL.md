---
name: claude-command-pinecone-quickstart
description: Converted from Claude plugin command "quickstart" (pinecone). Use when
  the user wants to run this slash-command workflow. Download AGENTS.md files for
  Pinecone, and kicksoff a quickstart using Python for Pinecone
---

# Claude Command (Imported): quickstart

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\pinecone\1.1.2\commands\quickstart.md`
- Plugin: `pinecone`
- Version: `1.1.2`
