---
name: claude-command-plugin-dev-create-plugin
description: Converted from Claude plugin command "create-plugin" (plugin-dev). Use
  when the user wants to run this slash-command workflow. Guided end-to-end plugin
  creation workflow with component design, implementation, and validation
---

# Claude Command (Imported): create-plugin

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\plugin-dev\2cd88e7947b7\commands\create-plugin.md`
- Plugin: `plugin-dev`
