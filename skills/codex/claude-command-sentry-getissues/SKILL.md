---
name: claude-command-sentry-getissues
description: Converted from Claude plugin command "getIssues" (sentry). Use when the
  user wants to run this slash-command workflow. Fetch the most recent 10 issues from
  Sentry, optionally filtered by project name
---

# Claude Command (Imported): getIssues

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\sentry\1.0.0\commands\getIssues.md`
- Plugin: `sentry`
- Version: `1.0.0`
