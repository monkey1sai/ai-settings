---
name: claude-command-sentry-seer
description: Converted from Claude plugin command "seer" (sentry). Use when the user
  wants to run this slash-command workflow. Ask natural language questions about your
  Sentry environment and get detailed insights using the Sentry MCP server
---

# Claude Command (Imported): seer

- Source: `C:\Users\monke\.claude\plugins\cache\claude-plugins-official\sentry\1.0.0\commands\seer.md`
- Plugin: `sentry`
- Version: `1.0.0`
