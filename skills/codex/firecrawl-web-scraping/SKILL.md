...
description: Enables intelligent web scraping and data extraction using Firecrawl.
  Use when extracting content from web pages, crawling sites, or searching the web.
---
